...
final _controllers = {
    'namaEvent': TextEditingController(),
    'lokasi': TextEditingController(),
    'deskripsi': TextEditingController(),
    'hargaTiket': TextEditingController(),
    'urlMaps': TextEditingController(),
    'jamMulai': TextEditingController(),
    'jamSelesai': TextEditingController(),
    'penyelenggara': TextEditingController(),
      ...
      await FirebaseFirestore.instance.collection('event_requests').add({
        ...
        'status': 'pending',
         'timestamp': DateTime.now(),
          'penyelenggara': _controllers['penyelenggara']!.text.trim(),
        'imageUrl': imageUrl,
        'userId': _userId,
        'username': _username,
        'email': _email,
  ...
  Widget _buildBasicInfoSection() {
    return _buildFormSection(
      ...
      children: [
        _buildTextField('nama', 'Nama Event', 'Masukkan nama event', Icons.tour_outlined),
