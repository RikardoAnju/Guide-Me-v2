...
class _GaleripageState extends State<Galeripage>
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Jelajahi Destinasi dan Event Wisata Kota Batam',
            style: GoogleFonts.poppins(
              fontSize: 16,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildGaleriCard(context, event);
            },
          ),
        ],
      ),
  ...
  Widget _buildGaleriCard(BuildContext context, Map<String, Object> event) {
