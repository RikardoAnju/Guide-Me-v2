...
import 'package:guide_me/daftar_user.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:guide_me/kelola_permintaan_rekomendasi_destinasi.dart';
import 'package:guide_me/kelolah_request_role.dart';
                  ...
                  children: [
                    ...
                    _buildManagementCard(
                      ...
                      () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const Kelolahuser())
                        );
                      },
                    ),
                    _buildManagementCard(
                      ...
                      () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const KelolahRekomendasi())
                        );
                      },
                    ),
                    _buildManagementCard(
                      ...
                      'Atur hak akses dan izin pengguna',
                      () {},
                    ),
                    _buildManagementCard(
                      context,
                      ...
                      'Kelola grup dan kategori pengguna',
                      () {},
                    ),
                    _buildManagementCard(
                      context,
                      ...
                      'Lihat statistik dan laporan penggunaan',
                      () {},
                    ),
                  ],
                ),
